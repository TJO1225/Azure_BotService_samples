...
upload files to Teams from a bot and how to receive a file sent to a bot as an attachment, can be found sample 5 [here](https://github.com/OfficeDev/Microsoft-Teams-Samples#bots-samples-using-the-v4-sdk)**
